...
- [ ] **M1.10** Minimal CLI/harness to exercise the core against a real host (manual
  + automated tests). → plan §6 ("demonstrable")
...
## M2 — Shell + Terminal + File manager  *(outline)*
...
## M3 — Editor + System monitor + transparency UI  *(outline)*  → completes v1
